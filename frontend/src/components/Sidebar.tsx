    ...
    >
      ...
      <div className="flex-0 flex flex-col p-4">
        ...
        <TogglableSlider
          ...
          max={20}
          step={0.01}
          value={values.inflation * 100}
          onChange={(val) => updateValue('inflation', val / 100)}
          enabled={sidebarOpen}
          format="%"
        />
        <TogglableSlider
          ...
          max={20}
          step={0.01}
          value={values.interest * 100}
          onChange={(val) => updateValue('interest', val / 100)}
          enabled={sidebarOpen}
          format="%"
        />
        <TogglableSlider
          ...
          max={20}
          step={0.01}
          value={values.asx * 100}
          onChange={(val) => updateValue('asx', val / 100)}
          enabled={sidebarOpen}
          format="%"
        />
        <hr className="border-gray-800 my-2" />
        ...
        <TogglableSlider
          ...
          max={1000}
          step={50}
          value={values.inspectionFees}
          onChange={(val) => updateValue('inspectionFees', val)}
          enabled={sidebarOpen}
          format="$"
        />
        <TogglableSwitch
        ...
        <TogglableSlider
          ...
          max={15}
          step={0.01}
          value={values.rentalFees * 100}
          onChange={(val) => updateValue('rentalFees', val / 100)}
          enabled={sidebarOpen}
          format="%"
        />
        <TogglableSlider
